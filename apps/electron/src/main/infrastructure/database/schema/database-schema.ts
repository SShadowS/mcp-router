import {
  ...
  SERVER_OAUTH_CONFIGS_SCHEMA,
  SERVER_OAUTH_CONFIGS_REQUIRED_COLUMNS,
  SERVER_OAUTH_TOKENS_SCHEMA,
  SERVER_OAUTH_TOKENS_REQUIRED_COLUMNS,
  OAUTH_AUTH_STATES_SCHEMA,
  OAUTH_AUTH_STATES_REQUIRED_COLUMNS,
  REQUEST_LOGS_SCHEMA,
...
export const DATABASE_SCHEMA = {
  ...
  serverOAuthConfigs: SERVER_OAUTH_CONFIGS_SCHEMA,
  serverOAuthTokens: SERVER_OAUTH_TOKENS_SCHEMA,
  oauthAuthStates: OAUTH_AUTH_STATES_SCHEMA,
...
export const SCHEMA_VERSION = {
  ...
  REQUIRED_COLUMNS: {
    ...
    serverOAuthConfigs: SERVER_OAUTH_CONFIGS_REQUIRED_COLUMNS,
    serverOAuthTokens: SERVER_OAUTH_TOKENS_REQUIRED_COLUMNS,
    oauthAuthStates: OAUTH_AUTH_STATES_REQUIRED_COLUMNS,
