  ...
  const handleGenerateToken = async () => {
    ...
    try {
      ...
      toast.success("Token Generated", {
        description:
          "Token has been generated and copied to clipboard. Store it securely!",
      });
    } catch (err) {
    ...
    <Dialog open onOpenChange={() => onClose()}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Manage access tokens for this client. Tokens provide authenticated
            access to MCP Router services.
          </DialogDescription>
        </DialogHeader>
            ...
            <Dialog open onOpenChange={() => setShowGenerateDialog(false)}>
              <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Select which servers this token can access (leave empty for
                    all servers)
                  </DialogDescription>
                </DialogHeader>
